...
/* ============================================================
 * ThermalMgmt :: coolant   (release R1.0)
...
/* REQ-THM-COO9 */
void Thm_Coolant_LegacyReset(void)
{
    /* REQ-THM-COO9: deprecated legacy reset, removed in R2.0. */
    g_thm_coolant_state.phase = THM_COOLANT_P_OFF;
}
