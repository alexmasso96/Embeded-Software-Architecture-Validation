...
{
    g_thm_fan_cfg.on_thresh_c = thm_fan_clamp_u16(v, 0xFFFFu);
}
...
/* REQ-THM-FAN9 */
void Thm_Fan_LegacyReset(void)
{
    /* REQ-THM-FAN9: deprecated legacy reset, removed in R2.0. */
    g_thm_fan_state.phase = THM_FAN_P_OFF;
}
