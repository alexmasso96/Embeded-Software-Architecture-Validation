...
/* ============================================================
 * BodyControl :: wipers   (release R1.0)
...
{
    g_bcm_wipers_cfg.interval_ms = bcm_wipers_clamp_u16(v, 0xFFFFu);
}
...
/* REQ-BCM-WIP9 */
void Bcm_Wipers_LegacyReset(void)
{
    /* REQ-BCM-WIP9: deprecated legacy reset, removed in R2.0. */
    g_bcm_wipers_state.phase = BCM_WIPERS_P_OFF;
}
