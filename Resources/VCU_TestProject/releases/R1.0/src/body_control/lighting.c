...
/* ============================================================
 * BodyControl :: lighting   (release R1.0)
...
{
    g_bcm_lighting_cfg.max_current_ma = bcm_lighting_clamp_u16(v, 0xFFFFu);
}
...
{
    /* REQ-BCM-LIG9: deprecated legacy reset, removed in R2.0. */
    g_bcm_lighting_state.phase = BCM_LIGHTING_P_OFF;
}
