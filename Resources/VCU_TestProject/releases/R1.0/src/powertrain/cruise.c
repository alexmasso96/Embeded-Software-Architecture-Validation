...
/* ============================================================
 * Powertrain :: cruise   (release R1.0)
...
{
    g_pwt_cruise_cfg.max_set_kph = pwt_cruise_clamp_u16(v, 0xFFFFu);
}
...
{
    /* REQ-PWT-CRU9: deprecated legacy reset, removed in R2.0. */
    g_pwt_cruise_state.phase = PWT_CRUISE_P_OFF;
}
