...
/* ============================================================
 * Powertrain :: gearbox   (release R1.0)
...
{
    g_pwt_gearbox_cfg.shift_delay_ms = pwt_gearbox_clamp_u16(v, 0xFFFFu);
}
...
/* REQ-PWT-GEA9 */
void Pwt_Gearbox_LegacyReset(void)
{
    /* REQ-PWT-GEA9: deprecated legacy reset, removed in R2.0. */
    g_pwt_gearbox_state.phase = PWT_GEARBOX_P_OFF;
}
