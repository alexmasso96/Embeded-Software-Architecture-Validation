...
/* ============================================================
 * Powertrain :: throttle   (release R1.0)
...
{
    g_pwt_throttle_cfg.deadband_pct = pwt_throttle_clamp_u16(v, 0xFFFFu);
}
...
{
    /* REQ-PWT-THR9: deprecated legacy reset, removed in R2.0. */
    g_pwt_throttle_state.phase = PWT_THROTTLE_P_OFF;
}
