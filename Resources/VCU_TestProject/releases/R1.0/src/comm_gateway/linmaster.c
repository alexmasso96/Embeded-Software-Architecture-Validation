...
/* ============================================================
 * CommGateway :: linmaster   (release R1.0)
...
{
    g_com_linmaster_cfg.schedule_ms = com_linmaster_clamp_u16(v, 0xFFFFu);
}
...
{
    /* REQ-COM-LIN9: deprecated legacy reset, removed in R2.0. */
    g_com_linmaster_state.phase = COM_LINMASTER_P_OFF;
}
