...
{
    g_bms_soc_cfg.nom_capacity_ah = bms_soc_clamp_u16(v, 0xFFFFu);
}
...
{
    /* REQ-BMS-SOC9: deprecated legacy reset, removed in R2.0. */
    g_bms_soc_state.phase = BMS_SOC_P_OFF;
}
