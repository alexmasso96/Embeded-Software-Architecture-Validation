...
/* ============================================================
 * BatteryMgmt :: balancing   (release R1.0)
...
/* REQ-BMS-BAL9 */
void Bms_Balancing_LegacyReset(void)
{
    /* REQ-BMS-BAL9: deprecated legacy reset, removed in R2.0. */
    g_bms_balancing_state.phase = BMS_BALANCING_P_OFF;
}
