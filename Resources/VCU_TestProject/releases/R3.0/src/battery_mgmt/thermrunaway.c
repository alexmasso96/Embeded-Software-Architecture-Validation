...
/* ============================================================
 * BatteryMgmt :: thermrunaway   (release R3.0)
...
/* REQ-BMS-THE3 */
void Bms_Thermrunaway_SetRunawayDtC(uint16_t v)
{
    g_bms_thermrunaway_cfg.runaway_dt_c = bms_thermrunaway_clamp_u16(v, 0xFFFFu);
}
