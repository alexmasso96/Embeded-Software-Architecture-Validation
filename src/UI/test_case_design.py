"""
Test Case Design — tab controller and token-completion widgets (Qt).

Moved out of Application_Logic/Logic_TestCase_Design.py in Phase 0 of the
pywebview migration; the condition tokenizer / suggestion engine stays there
as pure functions. Legacy PyQt UI — retires in Phase 4.
"""
import os
import re
